...
`)
  ...
  if (sec == "aç") {
    ...
    return message.channel.send(`<@${message.author.id}> Maalesef Premium Süresi Bitmiştir. Hizmetimizden Memnun Olduysanız Tekrar Alabilirsiniz \`g!premium\``)
  } else {
  if (!kanal) {
    return message.reply(`Anti Raid Bot Sistemi Örnek Kullanımı \`g!anti-raid-bot-sistemi aç/kapat #logkanalı\``)
  }
