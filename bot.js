...
/////
const app = express()
app.get('/', (req, res) => res.send("Bot Aktif Kullanıma Hazır."))
...
.setColor("RED")
.setTitle("${BuilderKit} Bot Kicklendi ")
.addField("${BuilderKit} Sunucu Adı:", guild.name)
.addField("${BuilderKit} Sunucu sahibi", guild.owner)
.addField("${BuilderKit} Sunucu Sahibi'nin ID'si", guild.ownerID)
.addField("${BuilderKit} Sunucunun Kurulu Olduğu Bölge:", guild.region)
.addField("${BuilderKit} Sunucudaki Kişi Sayısı:", guild.memberCount)

   client.channels.get('809144957302079568').send(rrrsembed);
